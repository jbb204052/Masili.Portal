    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('posted_by', models.CharField(max_length=50)),
                ('post_status', models.CharField(choices=[['PUBLISHED', 'PUBLISHED'], ['DRAFT', 'DRAFT']], default='DRAFT', max_length=50)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(max_length=50)),
                ('blotter', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='home.blotter')),
            ],
        ),
        migrations.CreateModel(
            name='Resident',
